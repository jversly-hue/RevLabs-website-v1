...
import { FileText, ArrowUpRight, Shield, Layers, Zap, Target } from 'lucide-react';
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="w-14 h-14 rounded-xl bg-[#262A33] border border-[#A78BFA]/20 flex items-center justify-center transition-colors">
                    <Icon className="w-6 h-6 text-[#A78BFA] transition-colors" />
                  </div>
