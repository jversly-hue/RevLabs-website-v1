  ...
  nl: {
    ...
    contact: {
      ...
      form: {
        ...
        industry: "Sector",
        industryPlaceholder: "Selecteer uw sector",
        industries: {
          dakwerken: "Dakwerken",
          hvac: "HVAC",
          other: "Anders"
        ...
        message: "Bericht",
        messagePlaceholder: "Vertel ons kort over uw situatie...",
        submit: "Verstuur bericht",
        submitting: "Versturen...",
        success: "Bedankt! We nemen snel contact met u op.",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "No, our systems are designed to be user-friendly. We provide complete training and support."
        },
        {
